...
In this thesis scope mainly \comment{tek kullanımlık} objects are considered generally. Nearly half of the material used in the project is disposable packets. Therefore as well as other words used but mainly trash is used to refer the material. 
