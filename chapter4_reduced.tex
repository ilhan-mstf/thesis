...
Beyond all of these for the audience the story of the collected materials is a mystery. Audience are not aware from all of these written in this thesis. I want to reveal the act behind these notebooks. For that reason a website that store the records of collected materials can be helpful. They can visit there anytime. The other other reason that I select to website is I am fluent in web development. 
...
% The development progress result in different part of the objects.
...
Every notebook has unique serial and with this it can be tracked down when it was produced and which materials are used production of it. Serial is generated through the first letter of composed metarial. 
...
% their dimensions matches.
In the production phase of the boxes, I discovered that my folded notebooks are fit into the many cardboxes. In other words dimensions of them are not very different. This property of items make the production easy. System supports the reuse of the object with less effort in this way.

At first I often cut the paper to match the dimensions of notebooks but later only folding gives the same result. Thus I can preserve their state. While turning objects to the notebooks I tried to be preserve their look and feel. Olabildigince az mudahelede bulundum. Bu sekilde onceki halleri hakkinda daha cok fikir sahibi olunabilir. Ben copleri taninir halde birakmak istiyordum. Neredeyse olduklari gibi biraktim. Gerisini onu kullananlara biraktim.
