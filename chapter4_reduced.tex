...
% Temel fikir sonra kullanmak için saklamak gerektigi. Bu acidan bakildiginda song dongun annesinin pratigi ile benzerlik gostermektedir. Song durumunda etkili olan farktorler ekonomik zorluklar ve boslugun doldurulmasiyla ilgili iken buradaki tam olarak belli degil. Ama benim yaklasimi aciklayan bir sey. Daha sonra kullanmak icin saklamak.
...
% Bu calismalardaki amacim farkli yuzeylerde resim yapabilmekti. Copu uzerine bir swyler yapmak benim icin yeni bir sey yapmakti. Deneysel bir yaklasimdi. Bir digeri ise bedavaydi. Kolayca elde edilen bir malzeme ve rahat ucuzlugundan dolayi bana daha fazla deneme imkani sunmaktaydi.

% cok ve kolay ulasilabildigi icin deneme imkani da cok. Benim icin cok iyi bir durum.

% Artik biriktirip, onlari daha sonrasi icin kullanabilirdim. Bunlari sadece yapmakla kalmiyordum, cevremdeki insanlara gosteriyordum, onlara hediye olarak veriyordum.

% ben bir suru bir suru yapiyordum. Kendi urunumu kendimin yapmak istiyordum. 

% cope bakis acim buradan hissedilebilir.

% tum imkansizliklara ragmen copten bir sey yapmak yerine aslinda imkanlarla birlikte copten bir sey yapmak. Hazir bir sey kullandigim zaman kolay kacmak olarak goruluyor. Ama benim amacim zoru basarmak degil ki? Boyle bir zorlamaya gerek var mi emin degilim. Bu zorlamanin artisi nedir bilmiyorum. 

% ben boyle kimsenin yapamayacagi bir seyle ugrasmak istemiyorum. Sadece ben yapmis olmak istemiyorum. Herkes yapabilir. Hatta yaapsin. Ben sadece yapan insani gostermek istiyorum. 
...
% ilk toplama hareketim aslinda belli noktalari konrtol etmek. Ama bunlari kesfetmem gerekti. Bunlari ise normal hayatin akisi icinde kesfettim. 

% found photosdaki adam da boyle bir mod var acikcasi.

% nicin atildigina gelince. Fazlalim olmasi, isini bitirmis olmasi. Labda unutulanlar ozellikle fazlalik hatali olmasi. Ve kimsenin umursamadigi bir sey olmasi. 

% copten beslenmek ile aslinda oldukca benzer noktalar var. Secerken konrol ediyorsun. Birakilma swbebini dusununce aslinda benim kulamnimjm icin uygun olmadigini anlayacaktim.
...
% ben kendim ve cevremdekilere bu is icin gereksiz yere cop urettirmemeliydim. Bu ise hile karistirmam olurdu.
...
% birakilmis bir seyi alirken yasanan huzursuzluk olarak tanimlasak bunu daha uygun olabilir. Onun baskasina bir sekilde ait oldugunu biliyorsun.

% tolanilan mrkanlar ise onemli. Fakir mahallesinde toplamak ile, zengin mallallesinde toplamak ayni sey degil. Ve devldtin coplugunu karistirmak ayni sey degil. Cope bir seyin izi ki ondan kurtulmak icin oguticuler var. Mesela herkesinkagidini alamadim. Her seyinde kagidinialamdim. Bohle bir sey mumkun degil.
...
% bırakıldığını nasıl anlıyordum vs. Uzun sure bekleyince. Zaten bunlarda cope gidiyorlar. Temizlikcinin onlari topladigini gordum ne de olsa ben. 
...
% kagit benim cevremde cok fazla kullanilan bir sey. 
...
% Bir kısmı çalıştığım ofiste tüketilen kahve paketlerinin ve onların taşındıkları poşetlerden oluşmakta. Diğerleri arkadaşın ofisinden, bir kısmı hocamdan. Bir kısmı da benim yoldan topladıklarım.
...
% Elimde bazılarının fotoğrafları var bazılarının ise yok. 
...
% websitesinde amac bun!ari anlatabilmekti. 
