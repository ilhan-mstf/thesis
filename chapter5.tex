...
% Agnes Varda mesela aslında farklı toplama biçimlerini araştırıyor. Ben de aslında bu tezde atığa dair farklı pratikleri keşfetmeye çalışıyorum.

% Agnes Varda belgeseline başlarken sözlük tanımından başlıyor. Sözlük tanımı aslında giriş için iyi bir başlangıç. Bir şeye başladığımızı görüyoruz.

% Dadaların kelimeleri rastgele oluşturdukları gibi ben de özellikle üzeri yazılı olan kağıtları karıştırıp kullandım. Bu konu hakkında ne diyorlar araştırmak gerekli.

% İsim verme yöntemi olarak aslında bir diğer yanda ise kurt'un yönetemi. Gene bir dada yaklaşımı. Nonsense kelime üretme pratiği
