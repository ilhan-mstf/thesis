...
\section{Summary}
What can be extracted from all these words? 

\begin{itemize}
\item Shared practice through the different ages of humanity and different societies. 
\item Moving nature of trash.
\item Classification, not the related with the object property. 
