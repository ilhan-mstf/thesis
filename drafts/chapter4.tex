...
% Daha öncesinden ne yaptığımı biliyor olmalı insanlar.
% Benim kriterlerim nedir?
% Benim kurallarım nelerdir?
...
[Organizing People] Well I  actually follow very simple methods. I just talk them all. I explain what I did, ask for their help. Everyone actually approached positively and somehow they contributed the project. How does it differ from asking for their help? What type of meaning I add here?

%%
%%
\item[Collected Materials.] There are different papers and objects are used to produce papers.
...
%%
%%
\item[Exhibition] Aim is to spread the idea by making something useful from trash. Increase diversity, activate (or encourage) people to embrace the trash.
...
Here are the name of notebooks and their story:
