...
\providecommand{\paraphrase}[1]{\textcolor{magenta}{#1}}
...
Çöp ve sanatsal eylem birlikte alınarak incelenmiştir. Çöp olgusu ve sanat dışı malzemelerin sanatta kullanılması sorgulanmıştır. Teoriler ve methodlar ele alınmıştır. Çöpün ne olduğu sorgulanmaktadır ve çöpe yeni bir bakış açısı kandırılmak amaçlandırılmaktadır.
