...
\usepackage{apacite}
\usepackage[a4paper,left=40.1mm,top=24.1mm,right=25.1mm,bottom=36mm]{geometry}
\usepackage{epigraph}
\usepackage{graphicx}
\usepackage{float}
\usepackage{caption}
...
\titlespacing{\chapter}{0pt}{9mm}{3\baselineskip}
...
\setlength{\cftbeforetoctitleskip}{19mm}
...
\setlength{\cftbeforeloftitleskip}{19mm}
...
% TODO yıl olayını düzeltmeli
% Bibliographyden sonra 4 boşluk olmalı?
